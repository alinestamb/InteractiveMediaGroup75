...
void setup() {
  ...
  tempslider = new CreateSliders(cp5, "Temp Slider", sliderx, slidery, 150, 30,        18.87097,24.03226        ,0);
  peopleslider = new CreateSliders(cp5, "People Counter", sliderx, slidery+(2*slideroffset), 150, 30,        1,48        ,0);
