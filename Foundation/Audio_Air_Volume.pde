class Audio_Air_Volume {
  ...
  void audiosetup(ControlP5 cp5) {
    ...
    Sample sample = null;
    try {
      sample = new Sample("/Users/LaraStamboulian/Downloads/InteractiveMediaGroup75-foundations_temp_blurry_Merge/InteractiveMediaGroup75-foundations_temp_blurry_Merge/Foundation/soundtrack_2.wav");
    } catch (Exception e) {
      e.printStackTrace();
      exit();
    }
    ...
    combinedSlider = cp5.addSlider("setCombinedValue")
                      ...
                      .setSize(150, 30)
                      .setRange(0.0, 1.5806) // Set the range for both parameters
